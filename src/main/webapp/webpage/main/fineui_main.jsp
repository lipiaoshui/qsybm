...
<head>
    ...
    <title><%-- <t:mutiLang langKey="jeect.platform"/> --%>轻收银系统</title>
	...
	<link rel="stylesheet" type="text/css" href="plug-in/themes/fineui/common/skin/dark/skin.css" id="layout-skin"/>
...
<body style="overflow-y:hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			<span class="header-logo">&nbsp&nbsp&nbsp&nbsp&nbsp轻收银系统</span>
...
<%-- 			<li class="header-bar-nav personInfo hiddenty-xs" style="cursor:pointer;"> 
			...
			<li class="header-bar-nav hiddenty-xs"> 
				<a href="javascript:createdetailwindow('待办事项','tSSmsController.do?goMySmsList',800,400)" title="换肤">
					<i class="icon-font">&#xe615;</i>&nbsp;待办事项
				</a>
			</li>			
<!-- 			
			<li class="header-bar-nav hiddenty-xs"> 
 	...
 	<%@include file="/context/picshow.jsp"%>	
