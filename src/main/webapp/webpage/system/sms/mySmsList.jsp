...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsList" checkbox="true" fitColumns="false" title="我的待办列表" actionUrl="tSSmsController.do?mydatagrid" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
   ...
   <t:dgCol title="待办标题"  field="esTitle" query="true" queryMode="single" ></t:dgCol>
