...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="common.department.list" fitColumns="true" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" pagination="false">
            ...
            <t:dgCol title="组织编码" field="orgCode" treefield="fieldMap.orgCode" width="50"></t:dgCol>
            ...
            <t:dgFunOpt funname="queryUsersByDepart(id)" title="view.member" urlclass="ace_button"  urlfont="fa-user"></t:dgFunOpt>
          	<%-- <t:dgFunOpt funname="queryInstByDepart(id,fieldMap.orgCode)" title="查看下属机构" urlclass="ace_button"  urlfont="fa-user"></t:dgFunOpt> --%>
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="addOrg()">组织录入</a>
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','departController.do?update','departList','680px','450px')">组织编辑</a>
...
<!--
    ...
    function queryInstByDepart(id,orgCode){
        var title = '下属机构列表';
        ...
        $('#userListpanel').panel("refresh", "departController.do?instList&orgCode=" + orgCode);
    }
