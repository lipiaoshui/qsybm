...
<t:datagrid name="userList" title="common.operation" checkbox="true" autoLoadData="true" actionUrl="userController.do?datagrid"  fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="desc,asc">
	...
	<t:dgCol title="常用地址" field="address" query="false" width="150"></t:dgCol>
<%-- 	<t:dgCol title="common.user.type" field="userType" dictionary="user_type" width="80"></t:dgCol>
 --%>	<%--<t:dgCol title="common.department" field="TSDepart_id" query="true" replace="${departsReplace}"></t:dgCol>--%>
	...
	<t:dgDelOpt title="删除" url="userController.do?delete&id={id}&deleteType=delete" urlclass="ace_button"  urlfont="fa-trash-o"/>
