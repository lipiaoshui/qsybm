	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" width="10%">
                <input id="realName" class="inputxt" name="realName" value="${user.realName }" maxlength="50" datatype="*2-50"/>
...
<%--                  <t:departSelect departId="${tsDepart.id }" departName="${tsDepart.departname }"></t:departSelect>
 --%>           
 <t:dictSelect field="orgIds" defaultVal="${orgIds}" dictTable="t_s_depart"  dictField="id" dictText="departname" datatype="*"></t:dictSelect>
...
<%--                 <input id="departname" name="departname" type="text" readonly="readonly" class="inputxt" datatype="*" value="${departname}"/>
		...
		<tr>
			...
			<td class="value" nowrap>
			 <t:dictSelect field="roleid" defaultVal="${id}" dictTable="t_s_role"  dictField="id" dictText="rolename" datatype="*" ></t:dictSelect>
			 <%-- <t:dictSelect field="roleid" defaultVal="${id}" dictCondition="where id ='40289d8164d0268f0164d02a27750001' "  dictTable="t_s_role"  dictField="id" dictText="rolename" datatype="*" ></t:dictSelect> --%>
...
<%--                 <input id="roleid" name="roleid" type="hidden" value="${id}"/>
		...
		<tr>
			<td align="right"><label class="Validform_label"> 常用地址: </label></td>
			<td class="value">
                <input class="inputxt" name="address" value="${user.address}" />
                <span class="Validform_checktip"></span>
            </td>
                        <input class="inputxt" name="devFlag" value="0" type="hidden"/>
		</tr>
