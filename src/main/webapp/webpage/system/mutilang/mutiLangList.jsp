...
<t:base type="jquery,easyui,tools"/>
  <t:datagrid name="mutiLangList" title="lang.maintain" autoLoadData="false" actionUrl="mutiLangController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="id" sortOrder="desc">
   ...
   <t:dgDelOpt title="common.delete" url="mutiLangController.do?del&id={id}"  urlclass="ace_button"  urlfont="fa-gift"/>
