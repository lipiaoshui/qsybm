  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="noticeController.do?doAdd" tiptype="1" >
		...
		<table style="width:99%" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="noticeTitle" name="noticeTitle" type="text" value="${tSNoticePage.noticeTitle}" datatype="*2-100" errormsg="标题必须是2到100位中文字符！" ignore="checked" style="width:340px" class="inputxt"  >
					     	 <input  name="createTime" type="hidden" value="${tSNoticePage.createTime}"  />
				...
				<tr>
					...
					<td class="value">
 						  	 <textarea id="noticeContent" name="noticeContent" style="width: 340px;height:150px;resize:none;border: 1px solid #D7D7D7" datatype="*"  value="${tSNoticePage.noticeContent}" rows="5" cols="40">${tSNoticePage.noticeContent}</textarea> 
