...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="qsyGoodsInfoList" checkbox="true" pagination="true" fitColumns="true" title="商品信息表" actionUrl="qsyGoodsInfoController.do?datagrid" idField="id" sortName="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="qsyGoodsInfoController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="qsyGoodsInfoController.do?goAdd" funname="add" width="600" height="270"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="qsyGoodsInfoController.do?goUpdate" funname="update" width="600" height="260"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="qsyGoodsInfoController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="qsyGoodsInfoController.do?goUpdate" funname="detail" width="600" height="260"></t:dgToolBar>
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'qsyGoodsInfoController.do?upload', "qsyGoodsInfoList");
}

//导出
function ExportXls() {
	JeecgExcelExport("qsyGoodsInfoController.do?exportXls","qsyGoodsInfoList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("qsyGoodsInfoController.do?exportXlsByT","qsyGoodsInfoList");
}
