...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="qsyGoodsInfoController.do?doUpdate">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="10%">
				<input id="goodsBarcode" class="inputxt" name="goodsBarcode" value="${qsyGoodsInfo.goodsBarcode}"  readonly="readonly" />
		...
		<td align="right" nowrap><label class="Validform_label"> 商品参考价：</label></td>
			<td class="value">
                <input id="goodPrice" class="inputxt" name="goodPrice" value="${qsyGoodsInfo.goodsReferPrice/100}"  maxlength="12" datatype="/(^[1-9]\d*(\.\d{1,2})?$)|(^0(\.\d{1,2})?$)/" errorMsg="请输入正确的价格" />
                <span class="Validform_checktip"></span>
            </td>
		</tr>
