...
<t:formvalid formid="formobj" refresh="false" dialog="true" action="qsyUserInfoController.do?savenewpwdforuser" usePlugin="password" layout="table">
	<input id="id" type="hidden" name="id" value="${qsyUserInfo.id }">
