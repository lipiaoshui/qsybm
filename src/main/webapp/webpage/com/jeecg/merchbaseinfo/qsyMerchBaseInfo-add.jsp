...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="qsyMerchBaseInfoController.do?doAdd">
	<input id="id" name="id" type="hidden"/>
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right" width="10%" nowrap><label class="Validform_label"> 商户名称: </label></td>
			<td class="value" width="10%">
                <input id="merchName" class="inputxt" name="merchName" maxlength="25" datatype="*"/>
		...
		<tr>
			...
			<td class="value" width="10%">
                <input id="businessLicenseNo" class="inputxt" name="businessLicenseNo" maxlength="25"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="legalRepreName"  datatype="*"  ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
			<tr>
			...
			<td class="value">
			<input id="legalRepreNum" class="inputxt" name="legalRepreNum"  maxlength="50" datatype="/(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$)/" 
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="credExpireDate" type="text" readonly="readonly"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="merchAddr" datatype="*"  ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="telephone" datatype="m"  ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
	</table>
