...
public class TSUser extends TSBaseUser implements java.io.Serializable {
	...
	public String toString() {
		...
		builder.append(this.getRealName());
		builder.append(", browser=");
		builder.append(this.getBrowser());
		builder.append(", userKey=");
		builder.append(this.getUserKey());
		builder.append(", password=");
		builder.append(this.getPassword());
		builder.append(", activitiSync=");
		builder.append(this.getActivitiSync());
		builder.append(", status=");
		builder.append(this.getStatus());
		builder.append(", deleteFlag=");
		builder.append(this.getDeleteFlag());
		builder.append(", signature=");
		builder.append(", departid=");
		builder.append(this.getDepartid());
		builder.append(", userOrgList=");
		builder.append(this.getUserOrgList());
		builder.append(", currentDepart=");
		builder.append(this.getCurrentDepart());
		builder.append("]");
