...
//		String requestPath = request.getRequestURI() + "?" + request.getQueryString();
	...
	public static String getUserSystemData(String key) {
		...
		if (key.equals(DataBaseConstant.SYS_USER_ID)) {
...
//		//替换为系统用户登录所使用的机构编码
//		if (key.equals(DataBaseConstant.INST_CODE)|| key.equals(DataBaseConstant.INST_CODE_TABLE)) {
//			returnValue = getSessionUser().getInstCode();
//		}
		//替换为当前系统时间(年月日)
