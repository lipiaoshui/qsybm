 ...
 */
@Entity
@Table(name = "qsy_channel_info", schema = "")
@SuppressWarnings("serial")
public class QsyChannelInfoEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="CHANNELCODE",nullable=true,length=20)
	 ...
	 */
	@Column(name ="CHANNELNAME",nullable=true,length=64)
	 ...
	 */
	@Column(name ="CHANNELDESC",nullable=true,length=64)
